...
export const franchises: Franchise[] = [
  ...
  { id: "trails", name: "轨迹系列", ja: "軌跡シリーズ", en: "Trails", description: "围绕轨迹系列的世界、新作与跨平台发售消息。", aliases: ["轨迹系列", "軌跡シリーズ", "空之轨迹", "空之軌跡", "空の軌跡", "零之轨迹", "零之軌跡", "零の軌跡", "碧之轨迹", "碧之軌跡", "碧の軌跡", "闪之轨迹", "閃之軌跡", "閃の軌跡", "创之轨迹", "創之軌跡", "創の軌跡", "黎之轨迹", "黎之軌跡", "黎の軌跡", "界之轨迹", "界之軌跡", "界の軌跡", "Trails in the Sky", "Trails of Cold Steel", "Trails from Zero", "Trails to Azure", "Trails into Reverie", "Trails through Daybreak", "Trails beyond the Horizon", "Trails at Sunrise", "Nayuta", "那由多"], sourceUrl: "https://www.falcom.co.jp/kiseki", color: "blue" },
  { id: "fire-emblem", name: "火焰纹章系列", ja: "ファイアーエムブレム", en: "Fire Emblem", description: "聚合火焰纹章的作品、战术玩法与发布动态。", aliases: ["火焰纹章", "火焰紋章", "圣火降魔录", "聖火降魔錄", "ファイアーエムブレム", "Fire Emblem", "风花雪月", "風花雪月", "風花雪月", "FE3H"], sourceUrl: "https://www.nintendo.com/jp/fe/index.html", color: "red" },
  ...
  { id: "persona", name: "女神异闻录系列", ja: "ペルソナ", en: "Persona", description: "收集女神异闻录游戏的新消息、视频与评测。", aliases: ["女神异闻录", "女神異聞錄", "ペルソナ", "Persona 3", "Persona 4", "Persona 5", "Persona 6", "Persona series", "Persona Q", "P3R", "P4G", "P5R"], sourceUrl: "https://p-ch.jp/", color: "red" },
